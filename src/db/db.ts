...
class DrovikDB extends Dexie {
  ...
  constructor() {
    ...
    // Version 12 — back-fills YouTube videoUrl onto existing seeded exercises.
    // Only touches rows where isCustom=false and videoUrl is still null, so any
    // URLs the user has set manually are never overwritten.
