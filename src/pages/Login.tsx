  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-app-bg">
      ...
      <div className="flex flex-col items-center mb-10">
        <div className="w-20 h-20 rounded-3xl bg-accent flex items-center justify-center mb-5 shadow-lg">
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10 text-app-text">
