 ...
 *
 * From here you can add, rename, reorder, and delete days.
 * Tap a day to open DayDetail and see/edit its exercises.
 */
...
export default function ProgramDetail() {
  ...
  // Count exercises per day for the subtitle.
    ...
    <div className="p-4">
      ...
      {days.length === 0 ? (
        <div className="rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-700 p-8 text-center text-gray-400">
          No days yet. Tap <strong>Add Day</strong> to get started.
        </div>
      ) : (
            ...
            <li key={day.id}>
              {confirmDelete !== day.id ? (
                <div className="flex items-center gap-2 rounded-xl bg-gray-50 dark:bg-gray-800/60 px-3 py-2">
                  ...
                  {/* Day name + exercise count — tap to open */}
                  <button
